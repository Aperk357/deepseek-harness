...
- `@deepseek-ai/dsh-experimental-nightwatch-session` — requires `sessionProjections` ([`packages/experimental/nightwatch-session/src/index.ts`](../packages/experimental/nightwatch-session/src/index.ts))
