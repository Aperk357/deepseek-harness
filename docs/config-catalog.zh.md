...
- `@deepseek-ai/dsh-experimental-nightwatch-session` — 需要 `sessionProjections`（[`packages/experimental/nightwatch-session/src/index.ts`](../packages/experimental/nightwatch-session/src/index.ts)）
