...
export const EFFECT_CORRELATION_ID = 'nightwatch-issue-131'
export const EFFECT_FAILURE_DOMAIN = 'shared-harness-chaos-proof'
export const EFFECT_LEASE_ID = 'pdv-attempt-1'
