...
| [`nightwatch-session`](nightwatch-session/README.md) | Nightwatch work-item binding and durable DSH-session operator projection | `ctx.sessionProjections` unit `nightwatchHarness` |
