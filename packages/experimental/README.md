...
| [`nightwatch-session`](nightwatch-session/README.md) | Private Nightwatch authority-tuple binding and read-only operator projection over one durable DSH session | `ctx.sessionProjections` unit |
